...
const getStyles = (isDark) => ({
  ...
  infoRow: { display: 'flex', alignItems: 'flex-start', gap: 8, textAlign: 'left', marginBottom: 18, maxWidth: 340 },
  infoText: { fontSize: 'clamp(12px, 1vw, 14px)', color: isDark ? 'rgba(255,255,255,0.65)' : 'rgba(0,0,0,0.60)', lineHeight: 1.65, margin: 0 },
