...
const getStyles = (isDark) => ({
  ...
  logoWrap: { width: 'clamp(52px, 6vw, 80px)', height: 'clamp(52px, 6vw, 80px)', marginBottom: 18, display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  description: { fontSize: 'clamp(12px, 1vw, 14px)', color: isDark ? 'rgba(255,255,255,0.60)' : 'rgba(0,0,0,0.55)', lineHeight: 1.65, marginBottom: 24 },
  ...
  codeInput: {
    width: 'clamp(38px, 4vw, 52px)', height: 'clamp(38px, 4vw, 52px)', borderRadius: 10,
    ...
    fontSize: 'clamp(16px, 1.5vw, 20px)', fontWeight: 600,
