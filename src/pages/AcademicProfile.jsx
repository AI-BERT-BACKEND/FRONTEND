...
const AcademicProfile = () => {
  ...
  const handleAddMateria = () => {
    if (!nuevaMateria.trim()) {
      setModalError('Ingresa el nombre');
      return;
    }
    if (form.materias.includes(nuevaMateria.trim())) {
      setModalError('Ya existe');
      return;
    }
            ...
            <div style={s.tagRow}>
              ...
              {form.materias.map((m) => (
                <div key={m} style={s.tag}>
                  ...
                  <button style={s.tagClose} onClick={() => handleRemoveMateria(m)}>
                    ✕
                  </button>
                </div>
              ))}
          ...
          <div style={s.card}>
            ...
            {disp.map((d) => (
              <div
                ...
                style={{
                  ...s.dispItem,
                  ...(form.disponibilidad === d.id ? s.dispItemActive : {}),
                }}
          ...
          <div style={s.card}>
            ...
            <div style={s.trabajaRow}>
              <button
                ...
                style={{
                  ...s.trabajaBtn,
                  ...(form.trabaja === 'SI' ? s.trabajaBtnActive : {}),
                }}
              >
                Sí
              </button>
              <button
                ...
                style={{
                  ...s.trabajaBtn,
                  ...(form.trabaja === 'NO' ? s.trabajaBtnActiveNo : {}),
                }}
              >
                No
              </button>
        ...
        <div style={s.modalOverlay} onClick={() => setShowModal(false)}>
          <div style={s.modalCard} onClick={(e) => e.stopPropagation()}>
            ...
            <div style={s.modalActions}>
              <button style={s.modalBtnSec} onClick={() => setShowModal(false)}>
                Cancelar
              </button>
              <button style={s.modalBtnPri} onClick={handleAddMateria}>
                Añadir
              </button>
            </div>
          </div>
...
const getStyles = (isDark) => {
  ...
  return {
    ...
    objetivoBtnActive: {
      background: t.primaryGradientReverse,
      border: 'none',
    },
    objetivoLabel: {
      fontSize: 11,
