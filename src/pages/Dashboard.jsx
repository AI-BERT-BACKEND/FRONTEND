                  ...
                  <div key={task.id} style={s.taskItem}>
                    ...
                    <div style={s.taskContent}>
                      ...
                      <div style={s.taskMeta}>
                        <span style={{ ...s.tag, background: task.tagColor + '30', color: task.tagColor }}>
                          {task.tag}
                        </span>
              ...
              <div style={{ ...s.card, ...s.aiCard, marginBottom: 0 }}>
                ...
                <div style={s.aiBody}>
                  <div style={s.mascotWrap}>
                    <img src={MascotaGif} alt="AI.BERT"
...
const getStyles = (isDark) => ({
  ...
  greeting: {
    ...
    padding: 0,
    color: isDark ? '#FF5B2E' : '#FF8430',
    /* Usamos color sólido para evitar problemas con WebkitTextFillColor en algunos navegadores */
    /* Si quieres gradiente en un navegador moderno puedes usar background-clip */
  },
  card: {
    background: isDark ? '#171717' : '#FEFAF9',
    border: `1px solid ${isDark ? 'rgba(255,255,255,0.08)' : 'rgba(220,193,181,0.30)'}`,
